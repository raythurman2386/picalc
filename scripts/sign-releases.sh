...
# ~/.picalc/signing/releases/<version>/checksums.txt.sig. The checksums.txt is
...
SIGNING_DIR="${PICALC_SIGNING_DIR:-$HOME/.picalc/signing}"
SECRET_KEY="${PICALC_SIGNING_KEY:-$SIGNING_DIR/secret.pem}"
...
Environment:
  PICALC_SIGNING_DIR   Override the signing directory (default: ~/.picalc/signing)
  PICALC_SIGNING_KEY   Override the secret key path
EOF
}
